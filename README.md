...
# goreporter [![Version Status](https://img.shields.io/badge/v3.0-release-blue.svg)](https://github.com/AshleyDumaine/goreporter/releases/tag/version3.0)

[![Current Release](https://img.shields.io/github/release/AshleyDumaine/goreporter.svg)](https://github.com/AshleyDumaine/goreporter/releases/latest)
[![Build Status](https://travis-ci.org/AshleyDumaine/goreporter.svg?branch=master)](https://travis-ci.org/AshleyDumaine/goreporter)
...
- [unittest](https://github.com/AshleyDumaine/goreporter/tree/master/linters/unittest) - Golang unit test status.
...
- [depth](https://github.com/AshleyDumaine/goreporter/tree/feature-3.0/linters/depth) - Count the maxdepth of go functions.
...
```bash
go get -u github.com/AshleyDumaine/goreporter
```
